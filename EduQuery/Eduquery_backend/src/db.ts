...
// ...existing code...
mongoose.connect("mongodb://ad_lonelyKing:Ayush123@cluster0-shard-00-00.8ex58.mongodb.net:27017,cluster0-shard-00-01.8ex58.mongodb.net:27017,cluster0-shard-00-02.8ex58.mongodb.net:27017/?replicaSet=atlas-m4lvz1-shard-0&ssl=true&authSource=admin", {
    dbName: 'eduquery'
}).then(() => {
