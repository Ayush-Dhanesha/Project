import { ShareIcon } from '../../icons/shareicon'; // Import the ShareIcon component
...
export function Card({ title, link, type }: CardProps) {
    return (
        <div>
            {/* Card Container */}
            <div className="p-4 bg-white rounded-md border-gray-200 max-w-72 border min-h-40 min-w-72">
                {/* Header Section */}
